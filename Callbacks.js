...
// Exercici 1.3: Callbacks
    // Nivell 1
        ...
        let processar = (nombre, callback) => callback (nombre)
        let greetings = nombre => console.log(`Hola ${nombre}`);
    ...
    // Nivell 3
        ...
        let processarCadena = (chain, callback) => callback (chain.toUpperCase())
